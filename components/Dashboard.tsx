  ...
  return (
    <div className="space-y-6 mb-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {/* Average */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md p-4 shadow-sm relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md p-6 shadow-sm flex flex-col">
            <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 flex items-center mb-6">
                <div className="w-8 h-8 rounded bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center mr-3 text-purple-900 dark:text-purple-400">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-md p-6 shadow-sm flex flex-col">
            <h3 className="text-sm font-bold text-slate-700 dark:text-slate-200 flex items-center mb-6">
                <div className="w-8 h-8 rounded bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center mr-3 text-emerald-600 dark:text-emerald-400">
            ...
            <div className="grid grid-cols-2 gap-4 text-center mb-6">
                <div className="bg-emerald-50 dark:bg-emerald-900/10 rounded p-2">
            ...
            <div className="space-y-3">
                <div className="space-y-1">
                     ...
                     <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-800 rounded-sm overflow-hidden">
                         <div className="h-full bg-blue-500 rounded-sm" style={{ width: `${Math.min(stats.components.daily, 100)}%` }}></div>
                     </div>
                </div>
                <div className="space-y-1">
                     <div className="flex justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                     ...
                     <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-800 rounded-sm overflow-hidden">
                         <div className="h-full bg-purple-800 dark:bg-purple-500 rounded-sm" style={{ width: `${Math.min(stats.components.midterm, 100)}%` }}></div>
                     </div>
                </div>
                <div className="space-y-1">
                     <div className="flex justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                     ...
                     <div className="h-1.5 w-full bg-slate-100 dark:bg-slate-800 rounded-sm overflow-hidden">
                         <div className="h-full bg-emerald-500 rounded-sm" style={{ width: `${Math.min(stats.components.final, 100)}%` }}></div>
                     </div>
                </div>
            </div>
        </div>
